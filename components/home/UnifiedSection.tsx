        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              style={{
                padding: '11px 8px',
                background: isActive ? 'var(--card-bg-elevated)' : 'transparent',
                border: 'none',
                borderRadius: 9,
                fontFamily: "'Noto Naskh Arabic', serif",
                fontSize: 13,
                color: isActive ? 'var(--therapy-blue-bright)' : 'var(--ink-muted)',
                cursor: 'pointer',
            ...
            >
              <span style={{ color: isActive ? 'var(--therapy-blue-bright)' : 'var(--ink-muted)' }}>
                {tab.icon}
              </span>
              {tab.label}
            </button>
